...
//Quels sont les 10 stations les plus desservies par les tram et bus sur la journée ?

public class MostTramandBusStation {
	
	private static final String INPUT_PATH = "input-TAM_MMM_OffreJour/";
	private static final String OUTPUT_PATH = "output/TAM/MostTramandBusStation-";
	...
	public static class Map extends Mapper<LongWritable, Text, Text, IntWritable> {
		private final static IntWritable tramAndBus = new IntWritable(1);
		@Override
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException{
			...
			context.write(new Text(stopName), tramAndBus);
		}
	}
	...
	public static class Reduce extends Reducer<Text, IntWritable, Text, IntWritable> {
		...
		public void reduce(Text key, Iterable<IntWritable> values, Context context)
			...
			stationNametoTotalFreq.put(key.toString(), sumTramAndBus);
		}
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf, "MostTramandBusStation");
