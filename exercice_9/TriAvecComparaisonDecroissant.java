...
public class TriAvecComparaisonDecroissant {
	private static final String INPUT_PATH = "input-groupBy/";
	private static final String OUTPUT_PATH = "output/9-TriAvecComparaisonDecroissant-";
	private static final Logger LOG = Logger.getLogger(TriAvecComparaisonDecroissant.class.getName());
